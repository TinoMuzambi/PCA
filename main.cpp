...
int main() {
    ...
    double percVarExplained = (totalVariance / cov.diagonal().sum()) * 100; // Computing percentage of total variance
    ...
    output << "5. Proportion of total variance explained by PCs 1 and 2:\n" << percVarExplained << "%" << endl;
    output.close();
